...
#include "CqsjPSFuncLib.generated.h"

/**
 * 
 */
UCLASS()
class CQSJPOWERFULSTATE_API UCqsjPSFuncLib : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()

public:
	UFUNCTION(BlueprintPure, Category = "Cqsj|PS|Value|Make", meta=(BlueprintThreadSafe))
	...
	UFUNCTION(BlueprintCallable, Category = "Cqsj|PS|Value")
	...
	UFUNCTION(BlueprintCallable, Category = "Cqsj|PS|State|Make")
	...
	UFUNCTION(BlueprintCallable, Category = "Cqsj|PS|State")
	...
	UFUNCTION(BlueprintCallable, Category = "Cqsj|PS")
	static UCqsjPowerfulStateComponent* GetPowerfulStateComponent(AActor* InActor);
	
	UFUNCTION(BlueprintCallable, Category = "Cqsj|PS", meta=(DefaultToSelf="InActor"))
	static void SetPowerfulState(AActor* InActor, bool bOnlyTriggerInServer, FGameplayTag Key, FPS_Value Value);
	UFUNCTION(BlueprintPure, Category = "Cqsj|PS|Pure", meta=(DefaultToSelf="AnimInstance", BlueprintThreadSafe))
	...
	UFUNCTION(BlueprintCallable, Category = "Cqsj|PE")
	...
	UFUNCTION(BlueprintCallable,Category = "Cqsj|PE", meta=(DefaultToSelf="InActor"))
